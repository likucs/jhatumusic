...
async def gstart(_, message: Message):
      ...
      reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "𝐎𝐖𝐍𝐄𝐑 👑••• 🎙️", url="https://t.me/iAmLiKu1")
                ]
            ]
        )
   )
